...
//    var dataArray = ['kong', 'fan', 'wu'];

  var adapter = PickerDataAdapter(data: [
//    PickerItem(text: Text('男'), value: '1'),
//    PickerItem(text: Text('女2'), value: '2'),
//    PickerItem(text: Text('女3'), value: '3'),
//    PickerItem(text: Text('女4'), value: '4'),
